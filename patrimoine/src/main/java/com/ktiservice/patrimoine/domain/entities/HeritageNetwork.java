...
public class HeritageNetwork extends BaseEntity {
    ...
    public static HeritageNetwork create(String siteName, String description, HeritageType heritageType,
        ...
        site.totalReviews = 0;
        site.totalVisits = 0;
        site.averageRating = BigDecimal.valueOf(0.0);
        return site;
    }
     ...
     */
    public void updateAverageRating(BigDecimal newAverage, Integer reviewCount) {
        this.averageRating = newAverage != null ? newAverage : BigDecimal.ZERO;
