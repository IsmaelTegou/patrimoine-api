...
import com.ktiservice.patrimoine.application.mappers.HeritageMapper;
...
public class HeritageApplicationService {
    ...
    public HeritageResponse updateConservationState(UUID siteId, ConservationState newState,
        ...
        oldValues.put("conservationState", oldState.toString());
        Map<String, Object> newValues = new HashMap<>();
        newValues.put("conservationState", newState.toString());
