...
public class ReviewJpaEntity {
     ...
     */
    public com.ktiservice.patrimoine.domain.entities.Review toDomainEntity() {
        var domain = new com.ktiservice.patrimoine.domain.entities.Review();
     ...
     */
    public static ReviewJpaEntity fromDomainEntity(com.ktiservice.patrimoine.domain.entities.Review domain) {
