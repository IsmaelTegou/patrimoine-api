...
import com.ktiservice.patrimoine.domain.enums.ConservationState;
...
public class HeritageNetworkJpaEntity {
     ...
     */
    public com.ktiservice.patrimoine.domain.entities.HeritageNetwork toDomainEntity() {
        var domain = new com.ktiservice.patrimoine.domain.entities.HeritageNetwork();
     ...
     */
    public static HeritageNetworkJpaEntity fromDomainEntity(com.ktiservice.patrimoine.domain.entities.HeritageNetwork domain) {
