...
import com.ktiservice.patrimoine.domain.enums.Language;
...
public class UserJpaEntity {
     ...
     */
    public com.ktiservice.patrimoine.domain.entities.User toDomainEntity() {
        var user = new com.ktiservice.patrimoine.domain.entities.User();
        user.setId(this.id);
     ...
     */
    public static UserJpaEntity fromDomainEntity(com.ktiservice.patrimoine.domain.entities.User user) {
