...
public class MediaJpaEntity {
     ...
     */
    public com.ktiservice.patrimoine.domain.entities.Media toDomainEntity() {
        var domain = new com.ktiservice.patrimoine.domain.entities.Media();
     ...
     */
    public static MediaJpaEntity fromDomainEntity(com.ktiservice.patrimoine.domain.entities.Media domain) {
