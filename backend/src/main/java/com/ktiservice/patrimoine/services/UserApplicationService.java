...
//     */
    ...
    public UserResponse create(CreateUserRequest request, String adminEmail) {
...
//     */
    ...
    public UserResponse update(UUID userId, String firstName, String lastName,
...
//     */
    @Transactional
    @CacheEvict(value = "users", key = "#userId")
    public void delete(UUID userId, String deletedBy) {
