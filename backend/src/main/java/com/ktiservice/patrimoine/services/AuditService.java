...
import com.ktiservice.patrimoine.entities.AuditLogEntity;
import com.ktiservice.patrimoine.repository.audit.AuditLogRepository;
...
public class AuditService {
    ...
    public void logAction(String action, String entityType, UUID entityId, UUID userId,
                          String userEmail, List<String> oldValues,
                          List<String> newValues, String description) {
        try {
